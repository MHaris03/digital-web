...
const SliderBar = () => {
  const slides = [
    "🏆 Partnering with Sky Rise Marketing was the best decision for our online strategy –",
    "🚀 350+ Real Results: 100% Quality Organic Leads – Sky Rise Marketing –",
    "💡 Transforming Creativity into Conversions – Sky Rise Marketing SaaS Campaign –",
    "🔥 120% ROI Growth in Just 3 Months – Sky Rise Marketing AI Success Story –",
  ];
